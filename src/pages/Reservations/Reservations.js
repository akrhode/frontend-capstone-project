    ...
    <div data-testid="reservations-component" className="reservation">
      ...
      {isPopupVisible && (
        <Popup
          ...
          description="Thank you for your request! Your reservation has been successfully made. You will receive a confirmation email with the details of your reservation."
        />
      )}
    </div>
  );
